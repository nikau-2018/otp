...
var _errorMessage = __webpack_require__(73);
...
var _ViewEventContainer = __webpack_require__(85);

var _ViewEventContainer2 = _interopRequireDefault(_ViewEventContainer);

var _CreateEvent = __webpack_require__(82);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(_reactRouterDom.Route, { path: '/event/add', component: _CreateEvent2.default })
      )
    )
  );
};
...
var _DrinkTile = __webpack_require__(83);

var _DrinkTile2 = _interopRequireDefault(_DrinkTile);
...
var CreateEvent = function (_React$Component) {
  ...
  _createClass(CreateEvent, [{
    ...
    key: 'getAllDrinks',
    value: function getAllDrinks() {
      return _superagent2.default.get('https://www.thecocktaildb.com/api/json/v1/1/filter.php?a=Alcoholic').then(function (res) {
...
var _ViewEvent = __webpack_require__(86);
...
exports.default = ViewEventContainer;
...
var Home = function (_React$Component) {
  ...
  function Home(props) {
    ...
    _this.getAllParties = _this.getAllParties.bind(_this);
    return _this;
  }
  ...
  _createClass(Home, [{
    ...
    value: function getAllParties() {
      return _superagent2.default.get('/api/v1/parties').then(function (res) {
    ...
    value: function componentDidMount() {
      ...
      this.getAllParties().then(function (parties) {
        _this2.setState({ parties: parties });
      });
    }
  }, {
    key: 'render',
